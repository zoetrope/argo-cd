...
func (_m *Clientset) NewRepoServerClient() (misc.Closer, apiclient.RepoServerServiceClient, error) {
	ret := _m.Called()

	var r0 misc.Closer
	if rf, ok := ret.Get(0).(func() misc.Closer); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(misc.Closer)
		}
	}
