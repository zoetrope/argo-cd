...
import fmt "fmt"
import math "math"
import _ "github.com/argoproj/argo-cd/engine/pkg/apis/application/v1alpha1"
...
func (*SessionCreateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_session_c8a9137d0fe8931e, []int{0}
}
...
func (*SessionDeleteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_session_c8a9137d0fe8931e, []int{1}
}
...
func (*SessionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_session_c8a9137d0fe8931e, []int{2}
}
...
func (*GetUserInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_session_c8a9137d0fe8931e, []int{3}
}
...
func (*GetUserInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_session_c8a9137d0fe8931e, []int{4}
}
...
func init() {
	proto.RegisterFile("server/session/session.proto", fileDescriptor_session_c8a9137d0fe8931e)
}

var fileDescriptor_session_c8a9137d0fe8931e = []byte{
	// 460 bytes of a gzipped FileDescriptorProto
	,
}
