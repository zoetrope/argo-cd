...
func TestProjectServer(t *testing.T) {
	...
	t.Run("TestClusterUpdateDenied", func(t *testing.T) {
		...
		projectServer := NewServer("default", fake.NewSimpleClientset(), apps.NewSimpleClientset(&existingProj, &existingApp), enforcer, misc.NewKeyLock(), nil)
	...
	t.Run("TestRemoveSourceUsedByAppSuccessfulIfPermittedByAnotherSrc", func(t *testing.T) {
		...
		projectServer := NewServer("default", fake.NewSimpleClientset(), apps.NewSimpleClientset(proj, &existingApp), enforcer, misc.NewKeyLock(), nil)
	...
	t.Run("TestDeleteProjectSuccessful", func(t *testing.T) {
		projectServer := NewServer("default", fake.NewSimpleClientset(), apps.NewSimpleClientset(&existingProj), enforcer, misc.NewKeyLock(), nil)
	...
	t.Run("TestDeleteDefaultProjectFailure", func(t *testing.T) {
		...
		projectServer := NewServer("default", fake.NewSimpleClientset(), apps.NewSimpleClientset(&defaultProj), enforcer, misc.NewKeyLock(), nil)
	...
	t.Run("TestCreateTokenDenied", func(t *testing.T) {
		...
		projectServer := NewServer("default", fake.NewSimpleClientset(), apps.NewSimpleClientset(projectWithRole), enforcer, misc.NewKeyLock(), sessionMgr)
	...
	t.Run("TestDeleteTokenDenied", func(t *testing.T) {
		...
		projectServer := NewServer("default", fake.NewSimpleClientset(), apps.NewSimpleClientset(projWithToken), enforcer, misc.NewKeyLock(), sessionMgr)
...
p, role:admin, projects, update, *, allow`)
	...
	t.Run("TestAddWildcardSource", func(t *testing.T) {
		...
		projectServer := NewServer("default", fake.NewSimpleClientset(), apps.NewSimpleClientset(proj), enforcer, misc.NewKeyLock(), nil)
	...
	t.Run("TestCreateRolePolicySuccessfully", func(t *testing.T) {
		...
		projectServer := NewServer("default", fake.NewSimpleClientset(), apps.NewSimpleClientset(projWithRole), enforcer, misc.NewKeyLock(), nil)
	...
	t.Run("TestSyncWindowsActive", func(t *testing.T) {
		...
		projectServer := NewServer("default", fake.NewSimpleClientset(), apps.NewSimpleClientset(projectWithSyncWindows), enforcer, misc.NewKeyLock(), sessionMgr)
